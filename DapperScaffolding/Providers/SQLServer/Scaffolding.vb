    ...
    Public Class Scaffolding
        ...
        Public Function Convert(cn As IDbConnection, path As String, lang As String, [namespace] As String, deleteFolder As Boolean) As ResultTask Implements IScaffolding.Convert
            ...
            Try
                ...
                Dim lstInformationSchema As List(Of InformationSchema) = cn.Query(Of InformationSchema)("SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE table_type = 'BASE TABLE' order by TABLE_NAME").ToList
                ...
                AnsiConsole.Progress().
                    ...
                    Start(Sub(ctx)
                              ...
                              For Each informationSchema In lstInformationSchema
                                  ...
                                  Dim resourceName As String = $"DapperScaffolding.MSSQL.TableToModel{lang}.sql"
                                  Dim query As String
